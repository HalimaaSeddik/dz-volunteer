...
from accounts.models import Volunteer, Organization
...
if created:
    ...
    admin.save()
    print(f"✓ Admin créé : admin@dzvolunteer.dz / admin123")
...
if created:
    ...
    print(f"✓ Bénévole 1 créé : amira.benali@email.dz / password123 (Badge Argent)")
...
if created:
    ...
    print(f"✓ Bénévole 2 créé : karim.mansouri@email.dz / password123 (Badge Bronze)")
...
if created:
    ...
    print(f"✓ Bénévole 3 créé : sarah.khelifi@email.dz / password123 (Badge Or)")
...
if created:
    ...
    print(f"✓ Organisation 1 créée : contact@cra.dz / password123 (Vérifiée)")
...
if created:
    ...
    print(f"✓ Organisation 2 créée : contact@greenalgeria.dz / password123 (Vérifiée)")
...
Cette mission s'inscrit dans notre programme annuel de solidarité. Rejoignez-nous pour faire une différence !''',
    ...
    if created:
        ...
        mission1.required_skills.add(premiers_secours, through_defaults={'verification_required': True})
