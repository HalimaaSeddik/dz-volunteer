...
def create_database():
    ...
    try:
        ...
        conn = psycopg2.connect(host="localhost", user="postgres", password="20772077")
...
def initialize_odds():
    ...
    odds_data = [
        ...
        (
            ...
            "التعليم الجيد",
            "#C5192D",
            "Assurer une éducation inclusive et équitable",
        ),
        (
            5,
        ...
        (
            ...
            "#FD9D24",
            "Faire en sorte que les villes soient inclusives",
        ),
        (
            12,
            ...
            "#BF8B2E",
            "Établir des modes de consommation durables",
        ),
        (
            13,
            ...
            "العمل المناخي",
            "#3F7E44",
            "Prendre des mesures pour lutter contre le climat",
        ),
        (
            14,
            "Vie aquatique",
        ...
        (
            ...
            "الحياة في البر",
            "#56C02B",
            "Gérer durablement les forêts et la biodiversité",
        ),
        (
            16,
        ...
        (
            ...
            "#19486A",
            "Renforcer les moyens de mise en œuvre",
        ),
    ]
...
def initialize_competences():
    ...
    for nom_fr, nom_ar, description in competences_data:
        if not Competence.objects.filter(nom_fr=nom_fr).exists():
            Competence.objects.create(nom_fr=nom_fr, nom_ar=nom_ar, description=description)
            created_count += 1
