...
from .models import Application, Mission, MissionSkillRequirement, Participation, Report, Review
...
class MissionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("ODD et Causes", {"fields": ("odd", "causes")}),
        ("Date et Horaires", {"fields": ("date", "start_time", "end_time", "duration_hours")}),
        (
            "Localisation",
            {
                "fields": (
        ...
        (
            "Accessibilité",
            {
                "fields": (
                    "accessible_by_car",
                    "accessible_by_transport",
                    "accessible_on_foot",
                    "pmr_accessible",
                )
            },
        ),
        ("Bénévoles", {"fields": ("required_volunteers", "accepted_volunteers")}),
        (
            "Prérequis",
            {
                "fields": (
