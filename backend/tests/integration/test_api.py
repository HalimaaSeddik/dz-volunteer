...
from accounts.models import User, Volunteer, Organization
...
class TestApplicationAPI:
    ...
    def test_apply_to_mission_success(self, api_client):
        ...
        # 4. POST Candidature
        url = f'/api/missions/volunteer/apply/'
        data = {
            'mission': mission.id,
            'motivation': 'Je suis très motivé pour cette mission!'
        }
    ...
    def test_apply_to_mission_already_applied(self, api_client):
        ...
        data = {
            'mission': mission.id,
            'motivation': 'Deuxième candidature (devrait échouer)'
        }
...
class TestValidateHoursAPI:
    ...
    def test_validate_hours_and_update_badge(self, api_client):
        ...
        url = f'/api/missions/organization/validate-hours/'
        data = {
