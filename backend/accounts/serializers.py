...
from missions.models import Mission, Application, Participation, Review
...
class RegisterOrganizationSerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        ...
        Organization.objects.create(
            user=user,
            email=validated_data.pop('email_org'),
            **validated_data
        )
...
class OrganizationPublicSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Organization
        fields = ('id', 'name', 'organization_type', 'description', 'wilaya', 
                  'logo', 'cover_photo', 'is_verified', 'total_missions', 
                  'total_volunteers', 'average_rating')
...
class MissionListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Mission
        fields = ('id', 'title', 'short_description', 'date', 'start_time', 'end_time',
                  'wilaya', 'commune', 'organization', 'odd', 'required_volunteers',
                  'accepted_volunteers', 'remaining_places', 'fill_percentage', 'image', 'status')
